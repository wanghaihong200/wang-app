...
def random_name():
    ...
    second_name = first_names[random.randint(0,len(first_names)-1)]
    third_name = first_names[random.randint(0,len(first_names)-1)]
    # 3个随机汉字组合成随机姓名
    full_name = last_name+second_name+third_name
    return full_name
